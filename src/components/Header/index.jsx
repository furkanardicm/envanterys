  ...
  return (
    <div className='w-screen  h-16 my-3 '>
      <div className="relative w-[80%] bg-white/30 border shadow-black/30 shadow-inner h-full mx-auto px-5 items-center flex flex-row justify-between rounded text-nowrap">
        ...
        {fullname && <a href='/settings' className='font-bold hover:text-black/70 flex flex-row gap-2 items-center justify-between md:relative sm:absolute sm:right-4 absolute right-4 '>{fullname} <FontAwesomeIcon className='text-2xl' icon={faUserGear} /></a> }
